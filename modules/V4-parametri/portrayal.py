...
server = ModularServer(HungerModel,[grid,chart,life_chart,exp_chart,food_poison_chart],"Hunger Model",{"N":BROJ_AGENATA,"width":DIMENZIJA_TABLE,"height":DIMENZIJA_TABLE,"num_of_food":BROJ_HRANE,"agent_walk_energy":WALK_ENERGY,"br_stepena_otrovnosti":STEPENI_OTROVNOSTI,"agent_memory_size":MEMORIJA_AGENATA})
server.port = 8521
server.launch()
